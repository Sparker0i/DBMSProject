...
"            <a href = \"#scroll-tab-2\" class = \"mdl-layout__tab is-active\">Zipcode</a>\n" +
...
"            <div class = \"page-content\">");
            ArrayList<Zip> zips = AddressHandler.getZips(new DataConnection().getConnection());
            out.println("<center><table border=\"1\">"
                    + "<tr><td>Zipcode</td><td>Area</td><td>Country</td></tr>");
            for (Zip zip: zips) {
                int z = zip.zipcode;
                String a = zip.area;
                String c = zip.city;
                out.println("<tr>" + "<td>" + z + "</td>" + "<td>" + a + "</td>" + "<td>" + c + "</td>" + "</td>");
            }
